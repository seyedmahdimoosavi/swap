  ...
  return (
    <div className="v3-container w-full">
      <div className="v3-tabs">
        <button
          className={`v3-tab${tab === "v3swap" ? " active" : ""}`}
          onClick={() => setTab("v3swap")}
        >
          Swap
        </button>
        <button
          className={`v3-tab${tab === "v3liquidity" ? " active" : ""}`}
          onClick={() => setTab("v3liquidity")}
        >
          Liquidity
        </button>
        <button
          className={`v3-tab${tab === "v3positions" ? " active" : ""}`}
          onClick={() => setTab("v3positions")}
        >
          Positions
        </button>
      </div>
      ...
      <div style={{ display: tab === "v3liquidity" ? "block" : "none" }}>
        ...
        {tab === "v3liquidity" && (
          <V3Liquidity selectedFee={selectedFee} onSelectFee={setSelectedFee} />
        )}
      </div>
